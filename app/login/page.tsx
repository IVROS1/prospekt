  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
        <h1 className="text-2xl font-bold text-slate-900 mb-1">Logga in</h1>
        <p className="text-slate-500 text-sm mb-6">Välkommen tillbaka</p>
        ...
        <p className="text-center text-xs text-slate-400 mt-5">
          Inget konto?{' '}
          <Link href="/signup" className="text-indigo-600 hover:underline">Skapa ett gratis</Link>
        </p>
      </div>
    </div>
  )
